<%-- 
    Document   : buyer
    Created on : 26-Oct-2024, 4:05:00 pm
    Author     : HOME
--%>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark  bg-dark">
            <div class="container-fluid">
                <div class="collapse navbar-collapse"  id="navbarnav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link" href="addbuyer.jsp">add</a>

                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="get_buyer.jsp">update</a>

                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link" href="buyer_details.jsp">details</a>
